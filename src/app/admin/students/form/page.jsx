...
export default function StudentFormPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Backend submit logic will go here later (POST/PUT to /api/students)
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Academic Info */}
        <FormSection title="Academic Information" delay={0.15}>
          <FormInput
            label="Roll Number"
            type="number"
            value={form.rollNumber}
        ...
        {/* Family Info */}
        <FormSection title="Family & Guardian" delay={0.2}>
          <FormInput
            label="Father's Name"
        ...
        {/* Contact Info */}
        <FormSection title="Contact & Address" delay={0.25}>
          <FormInput
        ...
        <div
          ...
          className="sticky bottom-4  p-4 flex items-center justify-end gap-3"
        >
          <button
            type="button"
            onClick={() => router.back()}
            className="px-5 py-2.5 rounded-xl border border-neutral-300 dark:border-neutral-800 text-sm font-semibold text-neutral-600 dark:text-neutral-300 hover: dark:hover:bg-subtle/30 transition-colors"
          >
            Cancel
          </button>
          <button
...
function FormSection({ title, delay = 0, children, className }) {
  return (
    <div
      className={`bg-background dark:bg-subtle/30 border border-neutral-400 dark:border-subtle/30 rounded-2xl p-5 md:p-6 shadow-sm`}
    >
      <h3 className="text-xs font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-widest mb-4">
        {title}
      </h3>
    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        <select
          value={value}
          onChange={(e) => onChange(e.target.value)}
          // এখানেও text-neutral-900 এবং dark:text-neutral-100 ব্যবহার করেছি
