...
export default function StudentDetailsPage() {
  ...
  return (
    <div className=" pb-10">
      ...
      <button
        onClick={() => router.back()}
        className="flex items-center gap-2 text-sm font-semibold text-neutral-600 dark:text-neutral-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors mb-6"
      >
      ...
      <div className=" dark:bg-subtle/30 rounded-2xl border border-neutral-400 dark:border-neutral-800 overflow-hidden shadow-sm">
        {/* Cover banner - emerald/gold gradient */}
        <div className="h-20 md:h-26 bg-gradient-to-r from-primary to-primary/20 relative z-10">
          <div
        ...
        <div className=" p-3 sm:p-6 relative z-20">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            ...
            <div className="flex gap-2">
              ...
              <a
                ...
                className="  flex items-center gap-2 px-4 py-2 rounded-lg bg-emerald-600 text-white text-xs xs:text-sm font-semibold hover:bg-emerald-700 transition-colors"
              >
                <MdPhone size={16} /> Call
              </a>

              {/* Edit Button */}
              <Link href={`/admin/students/form/${id}`} className="  flex items-center gap-2 px-4 py-2 rounded-lg bg-neutral-100 dark:bg-subtle text-neutral-700 dark:text-neutral-200 text-xs xs:text-sm font-semibold hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors">
                <MdEditNote size={16} /> Edit
              </Link>

              {/* Delete Button */}
              <button className="  flex items-center gap-2 px-4 py-2 rounded-lg bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-xs xs:text-sm font-semibold hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors">
          ...
          <div className="flex flex-wrap gap-2 mt-5">
            ...
            <Badge label={student.group || "-"} accent />
            <Badge
              label={
      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-4 mt-6">
        <InfoCard
          ...
          icon={<MdPerson className="text-emerald-500" />}
          rows={[
            {
        ...
        <InfoCard
          ...
          icon={<MdSchool className="text-emerald-500" />}
          rows={[
            {
    ...
    <span
      className={`px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wide ${
        accent
          ...
          : "bg-neutral-100 dark:bg-subtle text-neutral-600 dark:text-neutral-400"
      }`}
    >
      {label}
    </span>
